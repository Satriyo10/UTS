...
public class uts {
     public static void main(String[] args) {
       Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("UTS 20 Mei 2024 oleh Mohammad Satriyo Megahti Lanang NIM 23201109");
        System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxx");
        
        // Input nama
        System.out.println("Mohammad Satriyo Megahti Lanang");
        ...
        // Menampilkan selamat datang
         System.out.println("Selamat Datang" + panggilan + "Satriyo" + nama);
        //9
